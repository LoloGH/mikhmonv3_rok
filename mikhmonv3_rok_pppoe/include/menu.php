...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
    ...
    $mpage = $_user_log;
    $lmenu = "menu-open";
  } elseif ($ppp == "secrets" || $enablesecr != "" || $disablesecr != "" || $removesecr != "" || $renewsecret != "" || $removeexpiredsecret != "" || $secretbyname != "") {
    $mppp = "active";
    $ssecretsl = "active";
    $ssecrets = "active";
    $mpage = $_pppoe_clients;
    $smenu = "menu-open";
  } elseif ($ppp == "addsecret") {
    $mppp = "active";
    $saddsecret = "active";
    $ssecrets = "active";
    $mpage = $_add_pppoe_client;
    $smenu = "menu-open";
  } elseif ($ppp == "profiles" || $removepprofile != "") {
    $mppp = "active";
    $spprofilel = "active";
    $spprofile = "active";
    $mpage = $_pppoe_profile;
    $ppmenu = "menu-open";
  } elseif ($ppp == "add-profile" || $ppp == "edit-profile") {
    $mppp = "active";
    $saddpprofile = "active";
    $spprofile = "active";
    $mpage = $_pppoe_profile;
...
<div id="sidenav" class="sidenav">
  ...
  <div class="dropdown-container <?= $smenu . $ppmenu . $pamenu; ?>">
   <!--clients-->
  <div class="dropdown-btn <?= $ssecrets; ?>"><i class="fa fa-users"></i> <?= $_pppoe_clients ?>
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $smenu; ?>">
    <a href="./?ppp=secrets&pprofile=all&session=<?= $session; ?>" class="<?= $ssecretsl; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-list"></i> <?= $_user_list ?> </a>
    <a href="./?ppp=addsecret&session=<?= $session; ?>" class="<?= $saddsecret; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-user-plus"></i> <?= $_add ?> </a>
  </div>
  <!--pppoe profile-->
  <div class="dropdown-btn <?= $spprofile; ?>"><i class="fa fa-pie-chart"></i> <?= $_pppoe_profile ?>
    <i class="fa fa-caret-down"></i>
  </div>
  <div class="dropdown-container <?= $ppmenu; ?>">
    <a href="./?ppp=profiles&session=<?= $session; ?>" class="<?= $spprofilel; ?>"> &nbsp;&nbsp;&nbsp;<i class="fa fa-list"></i> <?= $_user_profile_list ?> </a>
