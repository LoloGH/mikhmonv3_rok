...
// get variable
  ...
  $removeexpiredsecret = $_GET['remove-pppsecret-expired'];
  $renewsecret = $_GET['renew-pppsecret'];
...
// pppoe clients (ppp secrets)
  elseif ($ppp == "secrets") {
    if ($pprofile == "" || $pprofile == "all") {
      $_SESSION['sbp'] = "";
    } else {
      $_SESSION['sbp'] = $pprofile;
    }
...
// renew pppoe client
  elseif ($renewsecret != "") {
    ...
    include_once('./process/renewpppsecret.php');
  }

// remove expired pppoe clients
  elseif ($removeexpiredsecret != "") {
    echo "<b class='cl-w'><i class='fa fa-circle-o-notch fa-spin' style='font-size:24px'></i> Processing...</b>";

    include_once('./process/removeexpiredsecret.php');
  }
