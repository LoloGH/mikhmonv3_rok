...
// ---------------------------------------------------------------------------
$_pppoe = "PPPoE";
$_pppoe_clients = "Clientes PPPoE";
$_pppoe_profile = "Perfil PPPoE";
$_add_pppoe_client = "Agregar Cliente PPPoE";
$_lock_caller_id = "Bloquear Caller ID";
$_status = "Estado";
$_st_active = "Activo";
$_st_waiting = "Sin activar";
$_st_expired = "Expirado";
$_st_disabled = "Deshabilitado";
$_renew = "Renovar";
$_enable = "Habilitar";
$_disable = "Deshabilitar";
$_activation = "Activacion";
$_activation_login = "En la primera conexion";
$_activation_now = "Ahora";
$_client_note = "Nombre, direccion, telefono...";
$_confirm_renew = "Esta seguro de renovar este cliente";
$_confirm_remove_client = "Esta seguro de eliminar este cliente";
$_confirm_remove_profile = "Esta seguro de eliminar este perfil";
$_confirm_remove_active = "Esta seguro de desconectar";
$_confirm_remove_expired = "Esta seguro de eliminar todos los clientes expirados?";

$_details_pppoe_profile = '
'.$_expired_mode.' es el control del cliente PPPoE.<br>
Opciones : Remove, Disable, Remove &amp; Record, Disable &amp; Record.
<ul>
<li>Remove: El cliente se elimina al expirar.</li>
<li>Disable: El cliente no se elimina, se deshabilita al expirar.</li>
<li>Record: Guarda el precio de cada activacion, para calcular el total en el mismo '.$_selling_report.' que el hotspot.</li>
</ul>
<p>'.$_lock_caller_id.' : el secret queda ligado a la MAC de la primera conexion.</p>
';

$_details_pppoe_client = '
La fecha de expiracion se guarda en el '.$_comment.' del cliente.<br>
<ul>
<li>'.$_activation_now.' : la fecha de expiracion se escribe de inmediato.</li>
<li>'.$_activation_login.' : Mikrotik la escribe en la primera conexion PPPoE.</li>
