...
// ---------------------------------------------------------------------------
$_pppoe = "PPPoE";
$_pppoe_clients = "Mga Kliyente PPPoE";
$_pppoe_profile = "PPPoE Profile";
$_add_pppoe_client = "Magdagdag ng Kliyente PPPoE";
$_lock_caller_id = "I-lock ang Caller ID";
$_status = "Katayuan";
$_st_active = "Aktibo";
$_st_waiting = "Hindi pa aktibo";
$_st_expired = "Expired";
$_st_disabled = "Naka-disable";
$_renew = "I-renew";
$_enable = "I-enable";
$_disable = "I-disable";
$_activation = "Pag-activate";
$_activation_login = "Sa unang koneksyon";
$_activation_now = "Ngayon";
$_client_note = "Pangalan, address, telepono...";
$_confirm_renew = "Sigurado ka bang i-renew ang kliyenteng ito";
$_confirm_remove_client = "Sigurado ka bang tanggalin ang kliyenteng ito";
$_confirm_remove_profile = "Sigurado ka bang tanggalin ang profile na ito";
$_confirm_remove_active = "Sigurado ka bang idiskonekta";
$_confirm_remove_expired = "Sigurado ka bang tanggalin ang lahat ng expired na kliyente?";

$_details_pppoe_profile = '
'.$_expired_mode.' ang kontrol para sa kliyente PPPoE.<br>
Mga pagpipilian : Remove, Disable, Remove &amp; Record, Disable &amp; Record.
<ul>
<li>Remove: Buburahin ang kliyente kapag nag-expire.</li>
<li>Disable: Hindi buburahin ang kliyente, ida-disable lang kapag nag-expire.</li>
<li>Record: Ise-save ang presyo ng bawat activation, para sa kabuuang benta sa parehong '.$_selling_report.' ng hotspot.</li>
</ul>
<p>'.$_lock_caller_id.' : ang secret ay naka-lock sa MAC address ng unang koneksyon.</p>
';

$_details_pppoe_client = '
Ang petsa ng expiration ay naka-imbak sa '.$_comment.' ng kliyente.<br>
<ul>
<li>'.$_activation_now.' : agad na isusulat ang petsa ng expiration.</li>
<li>'.$_activation_login.' : isusulat ito ng Mikrotik sa unang koneksyong PPPoE.</li>
