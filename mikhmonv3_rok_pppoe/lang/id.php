...
// ---------------------------------------------------------------------------
// Manajemen klien PPPoE
// ---------------------------------------------------------------------------
$_pppoe = "PPPoE";
$_pppoe_clients = "Klien PPPoE";
$_pppoe_profile = "Profile PPPoE";
$_add_pppoe_client = "Tambah Klien PPPoE";
$_lock_caller_id = "Kunci Caller ID";
$_status = "Status";
$_st_active = "Aktif";
$_st_waiting = "Belum aktif";
$_st_expired = "Kadaluarsa";
$_st_disabled = "Nonaktif";
$_renew = "Perpanjang";
$_enable = "Aktifkan";
$_disable = "Nonaktifkan";
$_activation = "Aktivasi";
$_activation_login = "Saat koneksi pertama";
$_activation_now = "Sekarang";
$_client_note = "Nama, alamat, telepon...";
$_confirm_renew = "Yakin memperpanjang klien ini";
$_confirm_remove_client = "Yakin menghapus klien ini";
$_confirm_remove_profile = "Yakin menghapus profile ini";
$_confirm_remove_active = "Yakin memutus koneksi";
$_confirm_remove_expired = "Yakin menghapus semua klien yang kadaluarsa?";

$_details_pppoe_profile = '
'.$_expired_mode.' adalah kontrol untuk klien PPPoE.<br>
Pilihan : Remove, Disable, Remove &amp; Record, Disable &amp; Record.
<ul>
<li>Remove: Klien dihapus saat kadaluarsa.</li>
<li>Disable: Klien tidak dihapus, hanya dinonaktifkan saat kadaluarsa.</li>
<li>Record: Menyimpan harga setiap aktivasi, untuk menghitung total penjualan pada '.$_selling_report.' yang sama dengan hotspot.</li>
</ul>
<p>'.$_lock_caller_id.' : secret dikunci ke MAC address pada koneksi pertama.</p>
';

$_details_pppoe_client = '
Tanggal kadaluarsa disimpan pada '.$_comment.' klien.<br>
<ul>
<li>'.$_activation_now.' : tanggal kadaluarsa langsung ditulis.</li>
<li>'.$_activation_login.' : Mikrotik menulisnya saat koneksi PPPoE pertama.</li>
