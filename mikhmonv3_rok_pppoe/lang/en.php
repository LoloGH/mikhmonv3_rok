...
// ---------------------------------------------------------------------------
$_pppoe = "PPPoE";
$_pppoe_clients = "PPPoE Clients";
$_pppoe_profile = "PPPoE Profile";
$_add_pppoe_client = "Add PPPoE Client";
$_lock_caller_id = "Lock Caller ID";
$_status = "Status";
$_st_active = "Active";
$_st_waiting = "Not activated";
$_st_expired = "Expired";
...
$_activation_login = "At first connection";
$_activation_now = "Now";
$_client_note = "Name, address, phone...";
$_confirm_renew = "Are you sure to renew this client";
$_confirm_remove_client = "Are you sure to delete this client";
$_confirm_remove_profile = "Are you sure to delete this profile";
$_confirm_remove_active = "Are you sure to disconnect";
$_confirm_remove_expired = "Are you sure to delete all expired clients?";

$_details_pppoe_profile = '
'.$_expired_mode.' is the control for the PPPoE client.<br>
Options : Remove, Disable, Remove &amp; Record, Disable &amp; Record.
<ul>
<li>Remove: Client will be deleted when it expires.</li>
<li>Disable: Client will not be deleted, it is disabled when it expires.</li>
<li>Record: Save the price of each activation. To calculate the total sales, in the same '.$_selling_report.' as the hotspot.</li>
</ul>
<p>'.$_lock_caller_id.' : the secret is bound to the MAC address of the first connection.</p>
';

$_details_pppoe_client = '
The expiration date is stored in the '.$_comment.' of the client.<br>
<ul>
<li>'.$_activation_now.' : the expiration date is written straight away.</li>
<li>'.$_activation_login.' : Mikrotik writes it at the first PPPoE connection.</li>
